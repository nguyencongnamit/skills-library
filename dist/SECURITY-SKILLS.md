...
- **defi-env-auditor** (npm, critical) — Part of the 'TrapDoor' supply-chain campaign (Socket, from 2026-05-22) — the first to weaponize npm, PyPI and crates.io simultaneously, disguising a crypto-focused credential stealer as developer/security tools aimed at crypto/DeFi/Solana/AI developers. Steals SSH keys, Sui/Solana/Aptos wallet keystores, AWS credentials, GitHub tokens, browser profile + wallet-extension data, env vars and API keys. npm execution path: a postinstall hook on install.
- **wallet-security-checker** (npm, critical) — Part of the 'TrapDoor' supply-chain campaign (Socket, from 2026-05-22) — the first to weaponize npm, PyPI and crates.io simultaneously, disguising a crypto-focused credential stealer as developer/security tools aimed at crypto/DeFi/Solana/AI developers. Steals SSH keys, Sui/Solana/Aptos wallet keystores, AWS credentials, GitHub tokens, browser profile + wallet-extension data, env vars and API keys. npm execution path: a postinstall hook on install.
- **eth-security-auditor** (pypi, critical) — Part of the 'TrapDoor' supply-chain campaign (Socket, from 2026-05-22) — the first to weaponize npm, PyPI and crates.io simultaneously, disguising a crypto-focused credential stealer as developer/security tools aimed at crypto/DeFi/Solana/AI developers. Steals SSH keys, Sui/Solana/Aptos wallet keystores, AWS credentials, GitHub tokens, browser profile + wallet-extension data, env vars and API keys. PyPI execution path: import-time fetch+exec of remote JavaScript.
- **async-pipeline-builder** (npm, critical) — Part of the 'TrapDoor' supply-chain campaign (Socket, from 2026-05-22) — the first to weaponize npm, PyPI and crates.io simultaneously, disguising a crypto-focused credential stealer as developer/security tools aimed at crypto/DeFi/Solana/AI developers. Steals SSH keys, Sui/Solana/Aptos wallet keystores, AWS credentials, GitHub tokens, browser profile + wallet-extension data, env vars and API keys. npm execution path: a postinstall hook on install.
- **cryptowallet-safety** (pypi, critical) — Part of the 'TrapDoor' supply-chain campaign (Socket, from 2026-05-22) — the first to weaponize npm, PyPI and crates.io simultaneously, disguising a crypto-focused credential stealer as developer/security tools aimed at crypto/DeFi/Solana/AI developers. Steals SSH keys, Sui/Solana/Aptos wallet keystores, AWS credentials, GitHub tokens, browser profile + wallet-extension data, env vars and API keys. PyPI execution path: import-time fetch+exec of remote JavaScript.
