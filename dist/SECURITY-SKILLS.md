...
- **sui-sdk-build-utils** (crates, critical) — Part of the 'TrapDoor' supply-chain campaign (Socket, from 2026-05-22) — the first to weaponize npm, PyPI and crates.io simultaneously, disguising a crypto-focused credential stealer as developer/security tools aimed at crypto/DeFi/Solana/AI developers. Steals SSH keys, Sui/Solana/Aptos wallet keystores, AWS credentials, GitHub tokens, browser profile + wallet-extension data, env vars and API keys. crates execution path: a malicious build.rs script at build time.
...
- **sui-framework-helpers** (crates, critical) — Part of the 'TrapDoor' supply-chain campaign (Socket, from 2026-05-22) — the first to weaponize npm, PyPI and crates.io simultaneously, disguising a crypto-focused credential stealer as developer/security tools aimed at crypto/DeFi/Solana/AI developers. Steals SSH keys, Sui/Solana/Aptos wallet keystores, AWS credentials, GitHub tokens, browser profile + wallet-extension data, env vars and API keys. crates execution path: a malicious build.rs script at build time.
...
- **eth-wallet-sentinel** (npm, critical) — Part of the 'TrapDoor' supply-chain campaign (Socket, from 2026-05-22) — the first to weaponize npm, PyPI and crates.io simultaneously, disguising a crypto-focused credential stealer as developer/security tools aimed at crypto/DeFi/Solana/AI developers. Steals SSH keys, Sui/Solana/Aptos wallet keystores, AWS credentials, GitHub tokens, browser profile + wallet-extension data, env vars and API keys. npm execution path: a postinstall hook on install.
